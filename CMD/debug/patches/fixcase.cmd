...
call rename 'ASMTBL.INC',   'asmtbl.inc'
call rename 'DEBUG.ASM',    'debug.asm'
call rename 'DISASM.INC',   'disasm.inc'
call rename 'DISTBL.INC',   'distbl.inc'
call rename 'DPRINTF.INC',  'dprintf.inc'
call rename 'DPRINTFR.INC',  'dprintfr.inc'
...
call rename 'LINEASM.INC',  'lineasm.inc'
...
call rename 'TRAPPV.INC',   'trappv.inc'
