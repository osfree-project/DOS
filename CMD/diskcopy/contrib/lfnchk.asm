...
FILESYSLENGTH EQU 32     ;; Sufficient according to RBIL

_DATA segment public word 'DATA'

	drive	  DB "?:\"

	filesys  DB FILESYSLENGTH dup (0)
...
CheckDriveOnLFN_:
	...
	mov  dx, offset drive ;; Pointer to drive string
	mov  cx, FILESYSLENGTH  ;; Set lentgh of buffer for file system string
	push ds                 ;; Far pointer
	pop  es
	mov  di, offset filesys        ;; to file system string
